...
public sealed partial class UsageGuideViewModel : ViewModelBase
{
    ...
    [
        new("baslangic", "Başlangıç Ekranı", "⌂", "01-ana-ekran-bos.jpg",
            ...
            ["Excel ekle düğmesiyle .xlsx veya .xlsm uzantılı bir kaynak seçin.", "Alternatif olarak Excel dosyasını boş kaynak alanına sürükleyip bırakın.", "Sağ kenardaki ok düğmesiyle rapor çalışma alanını açıp kapatın.", "Word Dosyası Oluştur düğmesini rapor tamamlandıktan sonra kullanın."],
            "Kaynak Excel dosyası doğrudan değiştirilmez; hücre düzenlemeleri uygulamanın çalışma verisinde tutulur."),

        new("excel-kaynagi", "Excel Kaynağı ve Worksheet", "▦", "02-demo-excel-yuklu.jpg",
            ...
            ["Alt sekmelerden Parca_Listesi, Uyari_Senaryolari veya Uzun_Parca_Listesi worksheet'ini seçin.", "No, Tr İsim, Parça Numarası, NSN, Seri Numarası ve Adet sütunlarını kontrol edin.", "Sütun harflerinin yanındaki kutularla aktarılacak sütunları belirleyin.", "Durum satırında otomatik algılanan veri aralığını doğrulayın."],
        ...
        new("veri-araligi", "Veri Aralığını Düzenle", "↔", "16-veri-araligi-birlesik.jpg",
            ...
            ["Veri Aralığını Düzenle düğmesine basın.", "Başlık satırı var seçeneğini kontrol edin.", "Demo dosyada başlık satırını 2, veri başlangıcını 3 ve bitiş sütununu F olarak doğrulayın.", "Yeniden Algıla otomatik tespit yapar; Uygula girilen sınırları çalışma alanına taşır."],
        ...
        new("worde-aktar", "Word'e Aktar", "→", "03-worde-aktar-yerlesim-onayi.jpg",
            ...
            ["Aktarılacak sütunları seçtikten sonra Word'e Aktar düğmesine basın.", "Yeni tablo olarak ekle veya mevcut tabloyu güncelle seçeneğini belirleyin.", "Başlık, alt başlık ve tablo adını onaydan önce düzenleyin.", "Onayla ve Önizle düğmesiyle aynı işlemi rapor ağacına ve Preview'a uygulayın."],
            "Başlık ya da alt başlık gerekmiyorsa ilgili satırın yanındaki eksi düğmesiyle katmanı kaldırabilirsiniz."),

        new("icindekiler-preview", "İçindekiler ve Preview", "☷", "04-preview-ve-icindekiler.jpg",
            "Rapor ağacını yönetir ve oluşturulan sayfaları Word'e aktarılmadan önce gerçek zamanlı olarak gösterir.",
            ["Başlık, Alt Başlık, Tablo, Üst Bilgi veya Alt Bilgi ekleyin.", "Seçili öğeyi yeniden adlandırın, silin, yukarı/aşağı taşıyın veya girintileyin.", "İçindekiler öğesine çift tıklayarak Preview'daki gerçek öğeye gidin.", "Sayfa sayısını ve tablo başlangıç konumunu Preview üzerinden kontrol edin."],
        ...
        new("tablo-ozellikleri", "Tablo Özellikleri", "⚙", "05-tablo-ozellikleri.jpg",
            ...
            ["İçindekiler panelinden tabloyu seçip Özellikler sekmesine geçin.", "Tablo adını, açıklamayı ve Tablo N: başlığında kullanılacak metni düzenleyin.", "Tablo biçimini seçin ve bağlı veri kaynaklarını kontrol edin.", "Seri No / Adet düzenini otomatik algılayın veya Düzenle düğmesiyle değiştirin.", "Uygula düğmesiyle Preview'ı yenileyin."],
        ...
        new("baslik-ozellikleri", "Başlık Özellikleri", "A", "06-baslik-ozellikleri.jpg",
            ...
            ["İçindekiler ağacında bir başlık seçin.", "Özellikler sekmesinde Metin alanını düzenleyin.", "Başlık 1 veya Başlık 2 düzeyini seçin.", "Uygula düğmesiyle numaralandırmayı ve Preview'ı yenileyin."],
        ...
        new("uyarilar", "Uyarılar", "!", "07-uyarilar.jpg",
            ...
            ["Uyarılar sekmesini açın ve Tümü, Hata, Uyarı veya Bilgi filtresini kullanın.", "Uyarı kartına tıklayarak ilgili rapor öğesine ve gerçek Excel hücresine gidin.", "Sorunlu hücreyi düzelttikten sonra açık bulgu sayısının yenilendiğini kontrol edin.", "Word çıktısından önce engelleyici Error bulgularını giderin."],
        ...
        new("hizli-rapor", "Hızlı Rapor", "⚡", "17-hizli-rapor-birlesik.jpg",
            ...
            ["Hızlı Rapor düğmesine basın ve kaynak worksheet'leri seçin.", "Seçim sırasını yukarı/aşağı düğmeleriyle düzenleyin.", "Her yapı için başlık, alt başlık ve tablo adlarını değiştirin.", "Rapor Yapısını Oluştur düğmesiyle tüm blokları aynı transfer motorundan geçirin."],
        ...
        new("word-ciktisi", "Word Dosyası Oluştur", "W", "11-word-ciktisi.jpg",
            ...
            ["Word Dosyası Oluştur düğmesine basın.", "Kayıt konumunu ve dosya adını seçin.", "İşlem tamamlanınca durum çubuğundaki Dosyayı Aç veya Klasörde Göster bağlantısını kullanın.", "Başlıkları, tablo caption'ını, devam sayfalarını ve seri/adet gruplamasını Word'de kontrol edin."],
