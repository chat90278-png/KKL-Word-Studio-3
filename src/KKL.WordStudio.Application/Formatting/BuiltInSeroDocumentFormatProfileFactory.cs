...
/// Values mirror the supported property profile extracted from the authoritative
/// Sero reference document. Imported project reference formats may replace this
/// profile, but Preview/Engine/Word consumers continue to receive only the
/// shared resolved-format contracts.
/// </summary>
public static class BuiltInSeroDocumentFormatProfileFactory
{
    public static DocumentFormatProfile Create() => new()
    {
        ...
        [
            CreateTableProfile(
                "built-in-sero-table-1",
                "Sero Referans Tablo 1",
                [5.13d, 30.04d, 15.49d, 18.33d, 21.08d, 9.93d]),
            CreateTableProfile(
                "built-in-sero-table-2",
                "Sero Referans Tablo 2",
