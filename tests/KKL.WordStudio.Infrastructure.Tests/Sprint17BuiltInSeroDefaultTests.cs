...
public sealed class Sprint17BuiltInSeroDefaultTests
{
    [Fact]
    public async Task NoProjectReference_ReturnsBuiltInSeroProfile()
    {
    ...
    [Fact]
    public async Task MissingProjectReference_FallsBackToBuiltInSeroProfileAndWarns()
    {
        ...
        Assert.Contains("Yerleşik KKL belge biçimi kullanılıyor", result.StatusMessage, StringComparison.Ordinal);
    }
}
