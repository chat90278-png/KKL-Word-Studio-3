...
public sealed class DocumentLayoutEngineContractTests
{
    [Fact]
    public async Task DeterministicLayout_ReturnsContractCompliantGeneratedPage()
    {
    ...
    [Fact]
    public async Task GeneratedDeterministicBlocks_PreserveElementIdAndEditableIdentity()
    {
