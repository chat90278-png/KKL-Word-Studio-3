...
public sealed class Sprint25UsageGuideArchitectureTests
{
    ...
    public void Guide_UsesApprovedFruitDemoWorkflowAndRealEmbeddedScreens()
    {
        ...
        {
            "01-ana-ekran-bos.jpg.base64",
            "02-demo-excel-yuklu.jpg.base64",
            "16-veri-araligi-birlesik.jpg.base64",
            "03-worde-aktar-yerlesim-onayi.jpg.base64",
            "04-preview-ve-icindekiler.jpg.base64",
            "05-tablo-ozellikleri.jpg.base64",
            "06-baslik-ozellikleri.jpg.base64",
            "07-uyarilar.jpg.base64",
            "17-hizli-rapor-birlesik.jpg.base64",
            "11-word-ciktisi.jpg.base64"
        };
        ...
        foreach (var screen in expectedScreens)
        {
            ...
            Assert.True(bytes.Length > 4, $"Guide screen is empty: {screen}");
